...
#
#     ##############
#     # cv2.imwrite(os.path.join('/data4/jyh/hv2/dataset/test_res/', 'bg.png'), blb * 255)
#     # print('------bg-end------')
#     #
#     h_dir = cv2.normalize(
#         h_dir_raw, None, alpha=0, beta=1, norm_type=cv2.NORM_MINMAX, dtype=cv2.CV_32F
#     )
#     # cv2.imwrite(os.path.join('/data4/jyh/hv2/dataset/test_res/', 'h.png'), h_dir * 255)
#     # print('------v-end------')
#     #################
#     # plt.imshow(h_dir * 255)
#     # plt.axis('off')
#     # plt.savefig('/data4/jyh/hv2/dataset/test_res/h.png')
#     # print('------height-end------')
#     #################
#     v_dir = cv2.normalize(
#         v_dir_raw, None, alpha=0, beta=1, norm_type=cv2.NORM_MINMAX, dtype=cv2.CV_32F
#     )
#     # cv2.imwrite(os.path.join('/data4/jyh/hv2/dataset/test_res/', 'v.png'), v_dir * 255)
#     # print('------v-end------')
#     # plt.imshow(v_dir * 255)
#     # plt.axis('off')
#     # plt.savefig('/data4/jyh/hv2/dataset/test_res/v.png')
#     # print('------width-end------')
#
...
#
#     #################
#     # plt.imshow(pred_type*255)
#     # plt.axis('off')
#     # plt.savefig('/data4/jyh/hv2/dataset/test_res/type.png')
#     # print('------type-end------')
#     # cv2.imwrite(os.path.join('/data4/jyh/hv2/dataset/test_res/', 'type.png'), pred_type * 255)
#     # print('------v-end------')
#     #################
#
#     inst_info_dict = None
