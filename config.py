...
class Config(object):
    ...
    def __init__(self):
        ...
        self.log_dir = "logs/ulsam/" # where checkpoints will be saved

        # paths to training and validation patches
        self.train_dir_list = [
            'dataset/training_data/%s/train/540x540_80x80/' % self.dataset_name
        ]
        self.valid_dir_list = [
            'dataset/training_data/%s/valid/540x540_80x80/' % self.dataset_name
        ]
